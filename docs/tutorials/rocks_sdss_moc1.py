...
start = time.time()
rocks.identify(ids, progress=True)
print(f"Getting ids took {time.time() - start:.3f}s.")

start = time.time()
rocks.rocks(ids, progress=True)
print(f"Getting rocks took {time.time() - start:.3f}s.")
