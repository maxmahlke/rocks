...
:gray:`Latest version: 1.5.13  -` `What's new? <https://github.com/maxmahlke/rocks/blob/master/CHANGELOG.md>`_ :gray:`| Bug or feature request? Open an issue on` `GitHub <https://github.com/maxmahlke/rocks/issues>`_:gray:`.`
