...
CLASS_TO_COMPLEX = {
    'A': 'A', 'Ad': 'U', 'AQ': 'U', 'AS': 'U', 'AU': 'U', 'AV': 'U',
    'B': 'B', 'BC': 'C', 'BCF': 'C', 'BCU': 'U', 'BFC': 'C','BFU': 'U',
    'BFX': 'U', 'Bk': 'U', 'BU': 'B', 
    'C': 'C', 'Caa': 'C', 'Cb': 'C', 'CB': 'C', 'CBU': 'C',
    'CD': 'U', 'CDX': 'U', 'CF': 'C', 'CFB': 'C', 'CFU': 'U', 'CFXU': 'U',
    'Cg': 'C', 'CG': 'C', 'CGSU': 'U', 'CGTP': 'U', 'CGU': 'U', 
    'Cgx': 'C', 'CL': 'U', 'CO': 'U', 'CP': 'U', 'CPF': 'U', 'CPU': 'U', 
    'CQ': 'U', 'CS': 'U', 'CSGU': 'U', 'CSU': 'U', 'CTGU': 'U', 'CU': 'U', 
    'CX': 'U', 'CXF': 'U',
    'Cgh': 'Ch', 'Ch': 'Ch',
    'D': 'D', 'DCX': 'U', 'DP': 'D', 'DU': 'D', 'Ds': 'D', 'DS': 'D',
    'DSU': 'D', 'DT': 'D', 'DTU': 'D', 'DU': 'D', 'DX': 'D', 'DXCU': 'D',
    'E': 'E', 'EM': 'X', 'EU': 'U',  
    'F': 'C', 'FBCU': 'U', 'FC': 'C', 'FCB': 'C', 'FCU': 'U', 'FCX': 'U',
    'FP': 'U', 'FU': 'U', 'FX': 'U', 'FXU': 'U',
    'G': 'C', 'GC': 'C', 'GS': 'U', 'G': 'U', 
    'J': 'V',  
    'K': 'K', 'Kl': 'U', 
    'L': 'L', 'LA': 'U', 'Ld': 'L', 'LQ': 'U', 'LS': 'U', 
    'M': 'M', 'MU': 'U', 
    'O': 'O', 'OV': 'U', 
    ...
    'TX': 'U',
    'V': 'V', 'Vw': 'V',
    'X': 'X', 'XB': 'U', 'Xc': 'X', 'XC': 'U', 'XCU': 'U', 'XD': 'U', 'XDC': 'U',
    'Xe': 'X',
